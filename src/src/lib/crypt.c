 ...
 *
 * NOTICE: This entire module was copied from MARS_NWE by Martin Stover. I've
 * tailored it a bit to suit my own needs.
 * 
 */
#include <stdlib.h>
#include <string.h>
...
void
shuffle (unsigned char *lon, const unsigned char *buf, int buflen, unsigned char *target) {
    int b2, d, s;
    buf32 temp;
